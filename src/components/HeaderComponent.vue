...
<header>
    <nav>
      ...
      <ul>
        <router-link to="/tos"><li>Termos</li></router-link>
        <router-link to="/team"><li>Equipe</li></router-link>
        <router-link to="/send"><li>Envio</li></router-link>
        <router-link to="/devol"><li>Devoluções</li></router-link> 
      </ul>
      <ul class="icons">
        <li>
